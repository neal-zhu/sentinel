...
class TokenUtils:
    ...
    @classmethod
    def is_stablecoin(
        cls, chain_id: int, token_address: str, token_symbol: str
    ) -> bool:
        """
        ...
        if chain_id in cls.STABLECOIN_ADDRESSES and token_address:
            if token_address.lower() in [
                addr.lower() for addr in cls.STABLECOIN_ADDRESSES[chain_id]
            ]:
                return True
    ...
    def is_high_interest_token(cls, chain_id: int, token_address: str) -> bool:
        ...
        return token_address.lower() in [
            addr.lower() for addr in cls.HIGH_INTEREST_TOKENS[chain_id]
        ]
    ...
    def get_token_symbol(
        ...
        chain_id: int,
        token_address: str,
        token_symbols_cache: Dict[str, str] = None,
    ) -> str:
        """
    ...
    @classmethod
    def format_token_value(
        cls,
        chain_id: int,
        token_address: str,
        value: int,
        token_decimals_cache: Dict[str, int] = None,
    ) -> float:
        """
