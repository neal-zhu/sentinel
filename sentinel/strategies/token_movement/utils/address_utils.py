...
class AddressUtils:
    ...
    @classmethod
    def is_contract_address(cls, address: str, known_dexes: Dict[int, List[str]] = None) -> bool:
        """
    ...
    @classmethod
    def is_whitelisted_address(cls, chain_id: int, address: str, whitelist: Dict[str, List[str]] = None) -> bool:
        """
    ...
    @classmethod
    def is_watched_address(cls, chain_id: int, address: str, watch_addresses: Dict[str, List[str]]) -> bool:
        """
